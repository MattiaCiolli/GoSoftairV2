...
(function ($) {
    ...
    $.fn.fileinputLocales['it'] = {
        ...
        msgSizeTooLarge: 'File troppo grande, max 1Mb',
        msgFilesTooLess: 'Seleziona una immagine da caricare',
        ...
        msgInvalidFileType: 'Sono ammessi solo file di tipo "{types}"',
        msgInvalidFileExtension: 'Sono ammessi solo file con estensione "{extensions}"',
        msgFileTypes: {
            'image': 'image',
            'html': 'HTML',
            'text': 'text',
