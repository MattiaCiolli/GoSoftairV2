			...
			<div class="card" id="bianco">
				<div class="row">
					<div class='col-sm-4 col-md-4 col-lg-4'>
						...
						<label class="col-md-12 personalLabel1">Annuncio inserito con successo</label>
					</div>
				</div>
				</br>
				<div class="row">
					<div class='col-sm-4 col-md-4 col-lg-4'>
						<a class="btn bottone1" 
							href="${pageContext.request.contextPath}/annuncio/bachecaAnnunci?pageNum=0">BACHECA ANNUNCI</a> 
