			...
			<div class="modal-content">
				...
				<div class="modal-body row">
					...
					<div class="col-md-12 col-lg-12">
						<div class="list-group nelmodal">
							<a class="list-group-item">
								<h4 class="list-group-item-heading">Non puoi visualizzare i contatti se non hai un profilo</h4>
								<p class="list-group-item-text">Registrati o esegui l'accesso</p> <a class="btn bottone1 accedi b" id="accedi">ACCEDI</a>
