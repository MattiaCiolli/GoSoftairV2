...
<link href="${pageContext.request.contextPath}/resources/fileinput/css/fileinput.min.css" rel="stylesheet">
<link href="${pageContext.request.contextPath}/resources/customCSS/mycss.css" rel="stylesheet">
...
<body id="sfondochiaro">
	...
	<div class="container-fluid immagineSfondo">
		<div class="card" id="bianco">
			<form id="partitaform" action="${pageContext.request.contextPath}/evento/update?idEvento=${evento.id}" method="post" enctype="multipart/form-data">
				<div class="row">
					<div class='col-sm-4 col-md-4 col-lg-4'>
						<div class="form-group">
							<label for="NomeEvento">Nome evento:</label>
							<input type="text" class="form-control" name="NomeEvento" id="NomeEvento" value="${evento.titolo}">
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class='col-sm-4 col-md-4 col-lg-4'>
						<div class="form-group">
							...
							<textarea rows="5" class="form-control" id="Descrizione" name="Descrizione"> ${evento.descrizione} </textarea>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class='col-sm-4 col-md-4 col-lg-4'>
						<div class="form-group">
							...
							<input type="number" class="form-control" name="NumPartecipanti" id="NumPartecipanti" value="${evento.numMaxPartecipanti}">
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class='col-sm-4 col-md-4 col-lg-4'>
						<div class="form-group">
							<label for="NumPartecipanti">Punto di incontro:</label> 
							<input type="text" class="form-control" name="PuntoIncontro" id="PuntoIncontro" value="${evento.puntoIncontro}">
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class='col-sm-12 col-md-6 col-lg-6 bg-scr'>
						<div class="form-group">
							...
							<input hidden type="text" name="Lon" id="Lon" value="${evento.lon}">
						</div>
					</div>
				</div>
				...
				<button type="submit" id="updatepartita" class="btn bottonenav">Update evento</button>
		</div>
		</form>
	</div>
	</div>
