		...
		<div class="container-fluid">
			<div class="col-md-12 SezEventi">
				...
				<div class="row">
					...
					<div class="sottotitoloBacheca">Vorresti provare ma non hai
				...
				<div class="centra">
					<ul class="pagination">
						<c:forEach var="i" begin="0" end="${numeroPagine}">							
							<li><a href="${pageContext.request.contextPath}/evento/bachecaEventi?pageNum=<c:out value="${i}"/>"><c:out value="${i+1}"/></a></li>						
						</c:forEach>
					</ul>
				</div>
	</div>
