...
<body class="cssBody BodyWidth">
	...
	<div class="bachecaPartite">
				...
				<div class="col-lg-12">
					<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
						<a href="${pageContext.request.contextPath}/views/evento/dettagli">
							<div class="carta">
								<img
									src="${pageContext.request.contextPath}/resources/img/evento1.jpg"
									class="img-carta" alt="...">
								<div class="caption">
					...
					<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
						<a href="#">
							<div class="carta">
								<img
									src="${pageContext.request.contextPath}/resources/img/evento2.jpeg"
									class="img-carta" alt="...">
								<div class="caption">
					...
					<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
						<a href="#">
							<div class="carta">
								<img
									src="${pageContext.request.contextPath}/resources/img/evento3.jpg"
									class="img-carta" alt="...">
								<div class="caption">
		...
		<div style="text-align: center">
			<ul class="pagination">
				<li><a
					href="${pageContext.request.contextPath}/views/evento/bachecaPartite.jsp">1</a></li>
