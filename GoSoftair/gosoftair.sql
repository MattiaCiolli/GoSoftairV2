--------------------------------------------------------
--  File creato - mercoledì-febbraio-08-2017   
--------------------------------------------------------
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into GOSOFTAIR.ANNUNCIO (ID,TITOLO,DESCRIZIONE,IMMAGINE,PREZZO,NUMEROTELEFONO,EMAIL,IDUTENTE,DATA) values ('42','dfff','dfdf','dinamodoge_compressed.jpg','4','45353','fh@sth','0',to_date('08-FEB-17','DD-MON-RR'));
...
Insert into GOSOFTAIR.EVENTO (ID,TITOLO,DESCRIZIONE,DATA,PUNTOINCONTRO,TIPOLOGIA,NMAXPARTECIPANTI,STATO,IDUTENTE,IMMAGINE) values ('101','qwerty','Cattura la bandiera',to_date('12-MAR-17','DD-MON-RR'),'latlong','Cattura la bandiera','5','1','0','20120804-.jpg');
Insert into GOSOFTAIR.EVENTO (ID,TITOLO,DESCRIZIONE,DATA,PUNTOINCONTRO,TIPOLOGIA,NMAXPARTECIPANTI,STATO,IDUTENTE,IMMAGINE) values ('84','afd','Deathmatch a squadre',to_date('08-FEB-17','DD-MON-RR'),'latlong','Deathmatch a squadre','4','1','1','dinamodoge_compressed.jpg');
Insert into GOSOFTAIR.EVENTO (ID,TITOLO,DESCRIZIONE,DATA,PUNTOINCONTRO,TIPOLOGIA,NMAXPARTECIPANTI,STATO,IDUTENTE,IMMAGINE) values ('100','asdasd','Dominio',to_date('09-FEB-17','DD-MON-RR'),'latlong','Dominio','4','1','0','dinamodoge_compressed.jpg');
