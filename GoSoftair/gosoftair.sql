...
SET DEFINE OFF;
Insert into GOSOFTAIR.EVENTO (ID,TITOLO,DESCRIZIONE,DATA,PUNTOINCONTRO,TIPOLOGIA,NMAXPARTECIPANTI,STATO,IDUTENTE,IMMAGINE,LATITUDINE,LONGITUDINE) values (0,'combattiamo!','un combattimento all''ultimo sangue',to_date('18/02/17','DD/MM/RR'),'Aquilone','Tutti contro tutti',12,1,1,'jumbo5.jpg',42.371724,13.363141);
Insert into GOSOFTAIR.EVENTO (ID,TITOLO,DESCRIZIONE,DATA,PUNTOINCONTRO,TIPOLOGIA,NMAXPARTECIPANTI,STATO,IDUTENTE,IMMAGINE,LATITUDINE,LONGITUDINE) values (101,'qwerty','Cattura la bandiera',to_date('12/03/17','DD/MM/RR'),'latlong','Cattura la bandiera',5,1,0,'20120804-.jpg',42.371724,13.363141);
Insert into GOSOFTAIR.EVENTO (ID,TITOLO,DESCRIZIONE,DATA,PUNTOINCONTRO,TIPOLOGIA,NMAXPARTECIPANTI,STATO,IDUTENTE,IMMAGINE,LATITUDINE,LONGITUDINE) values (84,'afd','Deathmatch a squadre',to_date('08/02/17','DD/MM/RR'),'latlong','Deathmatch a squadre',4,1,1,'dinamodoge_compressed.jpg',42.371724,13.363141);
...
Insert into GOSOFTAIR.EVENTO (ID,TITOLO,DESCRIZIONE,DATA,PUNTOINCONTRO,TIPOLOGIA,NMAXPARTECIPANTI,STATO,IDUTENTE,IMMAGINE,LATITUDINE,LONGITUDINE) values (20,'pipo','Deathmatch a squadre',to_date('10/02/17','DD/MM/RR'),'latlong','Deathmatch a squadre',9,1,0,'Screen Shot 2017-02-06 at 10.36.18.png',42.371724,13.363141);
