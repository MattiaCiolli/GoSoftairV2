  ...
  CREATE TABLE "GOSOFTAIR"."EVENTO" 
   (	"ID" NUMBER(3,0) NOT NULL ENABLE, 
	...
	"IDSQUADRA1" NUMBER NOT NULL ENABLE, 
	"IDSQUADRA2" NUMBER NOT NULL ENABLE, 
	"IDUTENTE" NUMBER NOT NULL ENABLE, 
	"IDFORUM" NUMBER NOT NULL ENABLE, 
  ...
  TABLESPACE "SYSTEM"  ENABLE, 
	 CONSTRAINT "EVENTO_FK1" FOREIGN KEY ("IDUTENTE")
	  REFERENCES "GOSOFTAIR"."UTENTE" ("ID") ENABLE, 
	 CONSTRAINT "EVENTO_FK2" FOREIGN KEY ("IDSQUADRA1")
	  REFERENCES "GOSOFTAIR"."SQUADRA" ("ID") ON DELETE CASCADE ENABLE, 
	 CONSTRAINT "EVENTO_FK3" FOREIGN KEY ("IDSQUADRA2")
	  REFERENCES "GOSOFTAIR"."SQUADRA" ("ID") ON DELETE CASCADE ENABLE
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  ...
  TABLESPACE "SYSTEM" ;
    ...
    CREATE TABLE "GOSOFTAIR"."SQUADRA" 
   (	"ID" NUMBER(3,0) NOT NULL ENABLE, 
  ...
  TABLESPACE "SYSTEM" ;
    ...
    CREATE TABLE "GOSOFTAIR"."UTENTE_SQUADRA" 
   (	"ID" NUMBER(3,0) NOT NULL ENABLE, 
	"IDSQUADRA" NUMBER(3,0) NOT NULL ENABLE, 
	"IDUTENTE" NUMBER(3,0) NOT NULL ENABLE, 
	 CONSTRAINT "UTENTE_SQUADRA_PK" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE, 
	 CONSTRAINT "UTENTE_SQUADRA_FK1" FOREIGN KEY ("IDUTENTE")
	  REFERENCES "GOSOFTAIR"."UTENTE" ("ID") ENABLE, 
	 CONSTRAINT "UTENTE_SQUADRA_FK2" FOREIGN KEY ("IDSQUADRA")
	  REFERENCES "GOSOFTAIR"."SQUADRA" ("ID") ENABLE
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
