...
SET DEFINE OFF;
Insert into GOSOFTAIR.EVENTO (ID,TITOLO,DESCRIZIONE,DATA,PUNTOINCONTRO,TIPOLOGIA,NMAXPARTECIPANTI,STATO,IDUTENTE,IMMAGINE,LATITUDINE,LONGITUDINE) values (0,'combattiamo!','un combattimento all''ultimo sangue',to_date('23/02/17','DD/MM/RR'),'poivediamo','Tutti contro tutti',12,1,1,'jumbo5.jpg',null,null);
Insert into GOSOFTAIR.EVENTO (ID,TITOLO,DESCRIZIONE,DATA,PUNTOINCONTRO,TIPOLOGIA,NMAXPARTECIPANTI,STATO,IDUTENTE,IMMAGINE,LATITUDINE,LONGITUDINE) values (101,'qwerty','Cattura la bandiera',to_date('12/03/17','DD/MM/RR'),'latlong','Cattura la bandiera',5,1,0,'20120804-.jpg',null,null);
Insert into GOSOFTAIR.EVENTO (ID,TITOLO,DESCRIZIONE,DATA,PUNTOINCONTRO,TIPOLOGIA,NMAXPARTECIPANTI,STATO,IDUTENTE,IMMAGINE,LATITUDINE,LONGITUDINE) values (84,'afd','Deathmatch a squadre',to_date('08/02/17','DD/MM/RR'),'latlong','Deathmatch a squadre',4,1,1,'dinamodoge_compressed.jpg',null,null);
Insert into GOSOFTAIR.EVENTO (ID,TITOLO,DESCRIZIONE,DATA,PUNTOINCONTRO,TIPOLOGIA,NMAXPARTECIPANTI,STATO,IDUTENTE,IMMAGINE,LATITUDINE,LONGITUDINE) values (100,'asdasd','Dominio',to_date('09/02/17','DD/MM/RR'),'latlong','Dominio',4,1,0,'dinamodoge_compressed.jpg',null,null);
Insert into GOSOFTAIR.EVENTO (ID,TITOLO,DESCRIZIONE,DATA,PUNTOINCONTRO,TIPOLOGIA,NMAXPARTECIPANTI,STATO,IDUTENTE,IMMAGINE,LATITUDINE,LONGITUDINE) values (20,'pipo','Deathmatch a squadre',to_date('10/02/17','DD/MM/RR'),'latlong','Deathmatch a squadre',9,1,0,'Screen Shot 2017-02-06 at 10.36.18.png',null,null);
Insert into GOSOFTAIR.EVENTO (ID,TITOLO,DESCRIZIONE,DATA,PUNTOINCONTRO,TIPOLOGIA,NMAXPARTECIPANTI,STATO,IDUTENTE,IMMAGINE,LATITUDINE,LONGITUDINE) values (40,'prova','Deathmatch a squadre',to_date('15/02/17','DD/MM/RR'),'latlong','Deathmatch a squadre',10,1,0,'Screen Shot 2017-02-14 at 14.26.10.png',null,null);
