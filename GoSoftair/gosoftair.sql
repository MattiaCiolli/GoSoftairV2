...
Insert into GOSOFTAIR.EVENTO (ID,TITOLO,DESCRIZIONE,DATA,PUNTOINCONTRO,TIPOLOGIA,NMAXPARTECIPANTI,STATO,IDUTENTE, IMMAGINE) values (0,'La valle della morte','Mettiata alla prova',to_date('03/05/17','DD/MM/RR'),'ciao',1,10,1,0, 'jumbo2.jpg');
Insert into GOSOFTAIR.EVENTO (ID,TITOLO,DESCRIZIONE,DATA,PUNTOINCONTRO,TIPOLOGIA,NMAXPARTECIPANTI,STATO,IDUTENTE, IMMAGINE) values (1,'combattiamo!','un combattimento all''ultimo sangue',to_date('23/02/17','DD/MM/RR'),'poivediamo',2,12,1,1, 'jumbo5.jpg');
